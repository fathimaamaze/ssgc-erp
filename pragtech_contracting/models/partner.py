...
class ResPartner(models.Model):
    ...
    vendor_status = fields.Selection(
        [('active', 'Active'), ('inactive', 'Inactive'), ('suspended', 'Suspended'), ('blocked', 'Blocked'),
         ('trail', 'Trail')], 'Vendor Status')
    ...
    contractor_status = fields.Selection(
        [('trial', 'Trial'), ('approved', 'Approved'), ('suspended', 'Suspended'), ('black_listed', 'Black Listed')],
        'Contractor Status', default='trial')
