...
class LabourContractorInfo(models.Model):
    ...
    name = fields.Many2one('res.partner', 'Contractor', required=True, domain=[('contractor', '=', True)],
                           ondelete='cascade', help="contractor of this product")
...
class LabourQuotationComparison(models.Model):
    ...
    contractor_line = fields.One2many('contractor.list', 'quotation_comp_contractor_id', string='Contractor Lines',
                                      copy=True)
    labour_quotation_details = fields.One2many('labour.quotation.details', 'labour_quotation_comp_detail_id',
                                               string='Labour Quotation Lines', copy=True)
    labour_quotation_comp_particular = fields.One2many('labour.quotation.compare.particular',
                                                       'labour_quotation_comp_pert_id',
    ...
    labour_quotation_comp_tax_details1 = fields.One2many('tax.details.contractor1', 'labour_quotation_comp_tax1_id',
                                                         string='Quotation Tax1 Details', copy=True)
    labour_quotation_comp_tax_details2 = fields.One2many('tax.details.contractor2', 'labour_quotation_comp_tax2_id',
                                                         string='Quotation Tax1 Details', copy=True)
    labour_quotation_comp_tax_details3 = fields.One2many('tax.details.contractor3', 'labour_quotation_comp_tax3_id',
                                                         string='Quotation Tax1 Details', copy=True)
    labour_quotation_comp_tax_details4 = fields.One2many('tax.details.contractor4', 'labour_quotation_comp_tax4_id',
                                                         string='Quotation Tax1 Details', copy=True)
    labour_quotation_comp_tax_details5 = fields.One2many('tax.details.contractor5', 'labour_quotation_comp_tax5_id',
                                                         string='Quotation Tax1 Details', copy=True)
    labour_quotation_comp_tax_details6 = fields.One2many('tax.details.contractor6', 'labour_quotation_comp_tax6_id',
                                                         string='Quotation Tax1 Details', copy=True)
    ...
    def confirm_action(self):
        ...
        no_of_approve = []
        no_of_products = [particular.labour_id for particular in self.labour_quotation_comp_particular if
    ...
    def onchange_project_wbs1(self):
        ...
        labour_quotation_lines = self.env['labour.quotation.line'].search(
            [('labour_id', 'in', labour_ids), ('order_id.date_order', '>=', self.from_date),
    ...
    def compute_labour_quotation_details(self):
        ...
        quotation_ids = self.env['labour.quotation'].search(
                ...
                for k, v in v_parent.items():
                    if k == selected_contractor_ids[0]:
                        ...
                        blank_line1 = self.env['quotation.compare.contractor1'].search(
                            [('labour_id', '=', line.labour_id.id), ('contractor_id', '=', None),
                             ('quotation_comp_cont1_id', '=', self.id)])
                        if not blank_line1:
                            vals = {
                                'labour_id': line.labour_id.id,
    ...
    @api.depends('quotation_comp_contractor1.amount', 'quotation_comp_contractor2.amount',
                 'quotation_comp_contractor3.amount',
                 'quotation_comp_contractor4.amount', 'quotation_comp_contractor5.amount',
                 'quotation_comp_contractor6.amount',
                 'labour_quotation_comp_tax_details1.tax', 'labour_quotation_comp_tax_details2.tax',
                 'labour_quotation_comp_tax_details3.tax',
                 'labour_quotation_comp_tax_details4.tax', 'labour_quotation_comp_tax_details5.tax',
                 'labour_quotation_comp_tax_details6.tax')
    ...
    @api.depends('quotation_comp_contractor1.negotiated_rate', 'quotation_comp_contractor1.amount',
                 'labour_quotation_comp_particular.labour_qty')
    ...
    @api.depends('quotation_comp_contractor2.negotiated_rate', 'quotation_comp_contractor2.amount',
                 'labour_quotation_comp_particular.labour_qty')
    ...
    @api.depends('quotation_comp_contractor3.negotiated_rate', 'quotation_comp_contractor3.amount',
                 'labour_quotation_comp_particular.labour_qty')
    ...
    @api.depends('quotation_comp_contractor4.negotiated_rate', 'quotation_comp_contractor4.amount',
                 'labour_quotation_comp_particular.labour_qty')
    ...
    @api.depends('quotation_comp_contractor5.negotiated_rate', 'quotation_comp_contractor5.amount',
                 'labour_quotation_comp_particular.labour_qty')
    ...
    @api.depends('quotation_comp_contractor6.negotiated_rate', 'quotation_comp_contractor6.amount',
                 'labour_quotation_comp_particular.labour_qty')
...
class LabourQuotationDetails(models.Model):
    ...
    tax_id = fields.Many2many('account.tax', 'labour_quot_detail_tax_rel', 'tax_id', 'lbr_quot_detail_id',
                              string='Taxes')
    ...
    labour_quotation_details_ = fields.One2many('labour.quotation.compare.particular',
                                                'labour_quotation_comp_pert_detail_id',
    ...
    labour_quotation_tax_per = fields.One2many('labour.tax.particular', 'labour_quotation_comp_taxper_detail_id',
                                               string='Quotation Particular Tax')
    quotation_tax1_detail_per = fields.One2many('tax.details.contractor1', 'labour_quotation_comp_tax1_detail_id',
                                                string='Quotation Detail Tax1')
    quotation_tax2_detail_per = fields.One2many('tax.details.contractor2', 'labour_quotation_comp_tax2_detail_id',
                                                string='Quotation Detail Tax2')
    quotation_tax3_detail_per = fields.One2many('tax.details.contractor3', 'labour_quotation_comp_tax3_detail_id',
                                                string='Quotation Detail Tax3')
    quotation_tax4_detail_per = fields.One2many('tax.details.contractor4', 'labour_quotation_comp_tax4_detail_id',
                                                string='Quotation Detail Tax4')
    quotation_tax5_detail_per = fields.One2many('tax.details.contractor5', 'labour_quotation_comp_tax5_detail_id',
                                                string='Quotation Detail Tax5')
    quotation_tax6_detail_per = fields.One2many('tax.details.contractor6', 'labour_quotation_comp_tax6_detail_id',
...
class LabourQuotationCompareParticular(models.Model):
    ...
    labour_quotation_comp_pert_detail_id = fields.Many2one('labour.quotation.details',
                                                           string='Labour Quotation details', ondelete='cascade')
...
class QuotationCompareContractor1(models.Model):
    ...
    quotation_comp_cont1_detail_id = fields.Many2one('labour.quotation.details', string='Labour Quotation details',
                                                     ondelete='cascade')
...
class QuotationCompareContractor2(models.Model):
    ...
    quotation_comp_cont2_detail_id = fields.Many2one('labour.quotation.details', string='Labour Quotation details',
                                                     ondelete='cascade')
    is_approve = fields.Boolean('Approve')
...
class QuotationCompareContractor3(models.Model):
    ...
    quotation_comp_cont3_detail_id = fields.Many2one('labour.quotation.details', string='Labour Quotation details',
                                                     ondelete='cascade')
    is_approve = fields.Boolean('Approve')
...
class QuotationCompareContractor4(models.Model):
    ...
    quotation_comp_cont4_detail_id = fields.Many2one('labour.quotation.details', string='Labour Quotation details',
                                                     ondelete='cascade')
    is_approve = fields.Boolean('Approve')
...
class QuotationCompareContractor5(models.Model):
    ...
    quotation_comp_cont5_detail_id = fields.Many2one('labour.quotation.details', string='Labour Quotation details',
                                                     ondelete='cascade')
    is_approve = fields.Boolean('Approve')
...
class QuotationCompareContractor6(models.Model):
    ...
    quotation_comp_cont6_detail_id = fields.Many2one('labour.quotation.details', string='Labour Quotation details',
                                                     ondelete='cascade')
    is_approve = fields.Boolean('Approve')
...
class LabourTaxParticular(models.Model):
    ...
    labour_quotation_comp_taxper_detail_id = fields.Many2one('labour.quotation.details',
                                                             string='Labour Quotation details', ondelete='cascade')
...
class TaxDetailsContractor1(models.Model):
    ...
    labour_quotation_comp_tax1_detail_id = fields.Many2one('labour.quotation.details', string='Quotation details',
                                                           ondelete='cascade')
...
class TaxDetailsContractor2(models.Model):
    ...
    labour_quotation_comp_tax2_detail_id = fields.Many2one('labour.quotation.details', string='Quotation details',
                                                           ondelete='cascade')
...
class TaxDetailsContractor3(models.Model):
    ...
    labour_quotation_comp_tax3_detail_id = fields.Many2one('labour.quotation.details', string='Quotation details',
                                                           ondelete='cascade')
...
class TaxDetailsContractor4(models.Model):
    ...
    labour_quotation_comp_tax4_detail_id = fields.Many2one('labour.quotation.details', string='Quotation details',
                                                           ondelete='cascade')
...
class TaxDetailsContractor5(models.Model):
    ...
    labour_quotation_comp_tax5_detail_id = fields.Many2one('labour.quotation.details', string='Quotation details',
                                                           ondelete='cascade')
...
class TaxDetailsContractor6(models.Model):
    ...
    labour_quotation_comp_tax6_detail_id = fields.Many2one('labour.quotation.details', string='Quotation details',
                                                           ondelete='cascade')
